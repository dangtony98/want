...
const AboutUsStyles = {
    jumbotron: {
        backgroundImage: 'linear-gradient(to top,rgba(0, 0, 0, 50%),rgba(0, 0, 0, 50%)), url(https://images.unsplash.com/photo-1449247666642-264389f5f5b1?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=3298&q=80)',
