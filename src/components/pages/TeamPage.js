...
const AboutUsStyles = {
    jumbotron: {
        backgroundImage: 'linear-gradient(to top,rgba(0, 0, 0, 50%),rgba(0, 0, 0, 50%)), url(https://images.unsplash.com/photo-1527664557558-a2b352fcf203?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2251&q=80)',
        ...
        <div className="information-page">   
            ...
            <div className="information-section marg-t-m">
                <div className="information-box">
                    <h2 className="information-text">Co-founders</h2>
                    ...
                    <h2 className="information-text">Team</h2>
                    <p className="information-text marg-t-sm">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit
                        , sed do eiusmod tempor incididunt ut labore et dolore magna 
                        aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco 
